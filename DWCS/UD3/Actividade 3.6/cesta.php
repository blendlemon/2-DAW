        ...
        <div class="card text-white bg-success mb-3 m-auto" style="width:40rem">
            <div class="card-body">
                ...
                if (!isset($_SESSION['cesta'])) {
                    ...
                    // echo "<ul>";
                    echo "<table border='1'> <tr> <th>Nombre </th> <th> Precio</th> <th>Unidades </th> <th>Subtotal </th> </tr>";
                    $total =0;
                    foreach ($listado as $k => $v) {
                        $subtotal = $v[1] * $_SESSION['cesta'][$k];
                        echo "<tr> <td>$v[0] </td> <td>$v[1]€</td> <td>{$_SESSION['cesta'][$k]} </td> <td>$subtotal €</td> </tr>";
